        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <button class="btn btn-primary"  type="button" onclick="excelList();">
            ...
            <div class="row row-lg">
                ...
                <div class="col-sm-12">
                    ...
                    <table id="listTable" class="table table-bordered" data-click-to-select="true"
                           ...
                           data-url="finance/rechargeOrderListPage">
                        <thead>
                        <tr>
                            ...
                            <th data-field="tradeNo" data-width="10%"
                                data-align="center"><span class="tdfont">流水号</span></th>

                            <th data-field="payTime" data-width="10%" data-formatter="formateDate"
                                data-align="center"><span class="tdfont">充值时间</span></th>

                            <th data-field="totalFee" data-width="10%" data-formatter="formatPrice"
                            ...
                            <th data-field="payStatus" data-width="10%" data-formatter="formateRechargeStatus"
...
<script>
    ...
    function excelList(){
        ...
        window.location.href="finance/rechargeOrderListExcel?startStr="+startStr + "&endStr=" + endStr + "&userPhone=" + userPhone;
    }
