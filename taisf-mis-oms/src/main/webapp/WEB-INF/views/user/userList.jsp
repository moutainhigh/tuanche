...
<script>
    ...
    function formatOperate(value, row, index) {
        var result = "";
        result = result + "<a title='编辑' onclick='toedit("+row.userUid+")'  data-toggle='modal' data-target='#editModal')>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;";
        result = result + "<a title='查看' onclick='detail("+row.userUid+")'  data-toggle='modal' data-target='#detailModal')>查看</a>";
        return result;
    }
    //编辑员工
    function toedit(userUid) {
        $.ajax({
            data: {
                'userUid': userUid,
            },
