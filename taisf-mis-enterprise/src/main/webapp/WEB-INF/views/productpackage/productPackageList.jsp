            ...
            <div class="row row-lg">
                ...
                <div class="col-sm-12">
                    ...
                    <table id="listTable" class="table table-bordered" data-click-to-select="true"
                           ...
                           data-url="productPackage/pageList">
                        <thead>
                        <tr>
...
<script>
    ...
    function formatOperate(value, row, index) {
        ...
        result = result + "<a title='配置' onclick='configurationPorduct(" + row.id + ")' >配置</a>";
        return result;
    }
    //编辑菜品
    function toedit(id) {
    ...
    function configurationPorduct(id){
        $.openNewTab(new Date().getTime(), "productPackage/productList?id="+id, "配置套餐");
    }
    ...
    function editSaveProduct() {
        ...
        $.ajax({
            ...
            type: "post",
            dataType: "json",
            url: 'productPackage/updateProduct',
            success: function (result) {
                if (result.code === 0) {
                    layer.alert("操作成功", {icon: 6, time: 2000, title: '提示'});
                    $('#listTable').bootstrapTable('refresh');
