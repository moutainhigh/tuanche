							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control" id="empSex" name="empSex">
										<option value="1"
											<c:if test="${employeeVo.empSex=='1'}" > selected="selected" </c:if>>男</option>
										<option value="2"
											<c:if test="${employeeVo.empSex=='2'}" > selected="selected" </c:if>>女</option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control" id="departName" type="text"
										name="departName" value="${employeeVo.departName}">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">
									<button type="button" class="btn btn-white" data-toggle="modal"
										data-target="#roleModel">角色选择</button>
								</label>
										...
										<c:forEach items="${employeeVo.roles}" var="role"
											...
											<div class="input-group">
												<input type="hidden" class="form-control" name="roleFidList"
													value="${role.roleFid }" /> <input type="text"
													class="form-control" name="roleName"
													value="${role.roleName}" /> <span class="input-group-btn"><button
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						onclick="getSelectRole()" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
