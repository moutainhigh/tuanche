...
<link rel="stylesheet" type="text/css"
	href="${staticResourceUrl}/css/plugins/webuploader/webuploader.css${VERSION}001">
<link rel="stylesheet" type="text/css"
	href="${staticResourceUrl}/css/demo/webuploader-demo.css${VERSION}001">
...
<body class="gray-bg">
				...
				<div class="float-e-margins">
					...
					<div class="ibox-content">
						...
						<div class="alert alert-warning">
							官方文档及更多示例请参考： <a href="http://fex.baidu.com/webuploader/"
	...
	<script
		src="${staticResourceUrl}/js/plugins/webuploader/webuploader.min.js${VERSION}001"></script>
