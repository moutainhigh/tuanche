...
public class ProductStockVO extends BaseEntity {
     ...
     * 午餐已卖出
     */
    private Integer lunchProductNum;
    ...
    public Integer getLunchProductNum() {
        return lunchProductNum;
    }

    public void setLunchProductNum(Integer lunchProductNum) {
        this.lunchProductNum = lunchProductNum;
    }
    ...
    public Integer getDinnerProductNum() {
        return dinnerProductNum;
    }

    public void setDinnerProductNum(Integer dinnerProductNum) {
        this.dinnerProductNum = dinnerProductNum;
    }
